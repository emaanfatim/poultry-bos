...
CREATE TABLE "cashier_discount_categories" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"tenant_id" uuid NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "cashier_discount_products" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"tenant_id" uuid NOT NULL,
	"user_id" uuid NOT NULL,
...
CREATE TABLE "payment_methods" (
	...
	"rounding_method" text DEFAULT 'exact' NOT NULL,
	"is_active" boolean DEFAULT true NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE "product_charge_category_assignment" (
	...
	"rate_override_calculation_type" text,
	"rate_override_value" numeric(14, 4),
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "product_charge_category_assignment_rate_override_shape" CHECK ((
        ("product_charge_category_assignment"."override_type" = 'override_rate'
          AND "product_charge_category_assignment"."rate_override_calculation_type" IS NOT NULL
          AND "product_charge_category_assignment"."rate_override_value" IS NOT NULL)
        OR
        ("product_charge_category_assignment"."override_type" <> 'override_rate'
          AND "product_charge_category_assignment"."rate_override_calculation_type" IS NULL
          AND "product_charge_category_assignment"."rate_override_value" IS NULL)
      ))
);
--> statement-breakpoint
...
CREATE TABLE "users" (
	...
	"requires_till_to_sell" boolean DEFAULT false NOT NULL,
	"requires_till_to_sell_scope" text DEFAULT 'all_bills' NOT NULL,
	"can_receive_handover" boolean DEFAULT false NOT NULL,
	"reports_to_id" uuid,
	"can_apply_custom_rounding" boolean DEFAULT false NOT NULL,
	"rounding_method_override" text,
	"can_create_miscellaneous_bills" boolean DEFAULT false NOT NULL,
	"can_apply_discount" boolean DEFAULT false NOT NULL,
	"max_discount_percentage" numeric(5, 2),
	"max_discount_flat_amount" numeric(10, 2),
	"discount_restricted_to_products" boolean DEFAULT false NOT NULL,
	"discount_restricted_to_categories" boolean DEFAULT false NOT NULL,
	"discount_bill_type_scope" text DEFAULT 'priced_and_unpriced' NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL
);
--> statement-breakpoint
...
ALTER TABLE "cashier_discount_categories" ADD CONSTRAINT "cashier_discount_categories_tenant_id_tenants_id_fk" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "cashier_discount_categories" ADD CONSTRAINT "cashier_discount_categories_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "cashier_discount_categories" ADD CONSTRAINT "cashier_discount_categories_category_id_product_categories_id_fk" FOREIGN KEY ("category_id") REFERENCES "public"."product_categories"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "cashier_discount_products" ADD CONSTRAINT "cashier_discount_products_tenant_id_tenants_id_fk" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "cashier_discount_products" ADD CONSTRAINT "cashier_discount_products_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "cashier_discount_products" ADD CONSTRAINT "cashier_discount_products_product_id_products_id_fk" FOREIGN KEY ("product_id") REFERENCES "public"."products"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "cashier_discount_categories_user_category_idx" ON "cashier_discount_categories" USING btree ("user_id","category_id");--> statement-breakpoint
CREATE UNIQUE INDEX "cashier_discount_products_user_product_idx" ON "cashier_discount_products" USING btree ("user_id","product_id");--> statement-breakpoint
