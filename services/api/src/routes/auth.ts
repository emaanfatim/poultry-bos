...
authRoutes.post("/login", async (c) => {
  ...
  const authUser = {
    ...
    requiresTillToSell: user.requiresTillToSell,
    requiresTillToSellScope: user.requiresTillToSellScope,
    ...
    maxDiscountFlatAmount: user.maxDiscountFlatAmount,
    discountRestrictedToProducts: user.discountRestrictedToProducts,
  };
  ...
  try {
    ...
    return c.json({
      user: {
        ...
        requiresTillToSell: dbUser.requiresTillToSell,
        requiresTillToSellScope: dbUser.requiresTillToSellScope,
        ...
        canApplyDiscount: dbUser.canApplyDiscount,
        maxDiscountPercentage: dbUser.maxDiscountPercentage,
        maxDiscountFlatAmount: dbUser.maxDiscountFlatAmount,
        discountRestrictedToProducts: dbUser.discountRestrictedToProducts,
      },
