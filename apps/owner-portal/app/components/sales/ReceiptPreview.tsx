    ...
    <div className="mx-auto max-w-lg">
                ...
                <>
                    ...
                    line.modifiers!.map((mod, mIdx) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          {isPriced && (
                            <td className="py-0.5 text-end text-xs text-[var(--accent)]">
                  ...
                  {isPriced && hasModifiers && modifierTotalNum > 0 && (
                    <tr className="border-b border-slate-100">
                      ...
                      <td className="pb-1.5 text-end text-xs font-semibold text-[var(--accent-hover)]">
      ...
      <div className="mt-4 flex gap-3 print:hidden">
        ...
        <button
          type="button"
          onClick={onClose}
          className="flex-1 rounded-xl bg-[var(--accent)] py-3 font-semibold text-white hover:bg-[var(--accent-hover)]"
        >
          Close
        </button>
      </div>
