...
export default function PosPage() {
  ...
  const handleConfirmPayment = async (
    ...
    try {
      ...
      if (billType === "priced") {
        // Fire-and-forget — don't block navigation on this, the header
        // widget will just pick it up a beat later if it's slow.
        refreshTill();
      }
      // Cash is no longer counted per sale — the cashier hands back change
      // by eye and the drawer is reconciled once at shift close (see
      // till/close), which compares expected vs actual cash and surfaces
      // any gap as a single transparent variance for the whole shift.
